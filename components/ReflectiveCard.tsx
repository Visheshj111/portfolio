...
import { Fingerprint, User, Activity, Lock, X } from 'lucide-react';
    ...
    return (
        <div className="relative inline-block">
            <button 
                ...
                className="absolute -top-3 -left-3 z-[100] bg-black/60 border border-white/20 hover:bg-white hover:text-black transition-all cursor-pointer p-1.5 rounded-full text-white shadow-xl backdrop-blur-md"
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-8 text-[var(--text-color,white)] bg-[var(--overlay-color,rgba(255,255,255,0.05))]">
                ...
                <div className="flex-1 flex flex-col justify-end items-center text-center gap-6 mb-8">
                    <div className="text-center">
                        <h2 className="text-2xl font-bold tracking-[0.05em] m-0 mb-2 drop-shadow-md">VISHESH JANGID</h2>
                        <p className="text-xs tracking-[0.2em] opacity-70 m-0 uppercase">FULL-STACK DEVELOPER</p>
                    </div>
                </div>

                <div className="flex justify-between items-end border-t border-white/20 pt-6">
                    <div className="flex flex-col gap-1">
                        <span className="text-[9px] tracking-[0.1em] opacity-60">GITHUB</span>
                        <span className="font-mono text-sm tracking-[0.05em]">@Visheshj111</span>
                    </div>
